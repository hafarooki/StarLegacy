...
object CombatNPCs : SLComponent() {
    ...
    override fun onEnable() {
        ...
        subscribe<EntityDamageEvent> { event ->
            ...
            val helmet = (entity as? ArmorStand)?.equipment?.helmet ?: return@subscribe
    ...
    fun isNPC(entity: ArmorStand): Boolean {
        ...
        val helmet = entity.equipment?.helmet.takeIf { it?.type != Material.AIR } ?: helmetMap[entity.uniqueId]

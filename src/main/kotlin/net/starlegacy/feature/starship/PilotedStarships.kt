...
object PilotedStarships : SLComponent() {
    ...
    fun tryPilot(player: Player, data: PlayerStarship, callback: (ActivePlayerStarship) -> Unit = {}): Boolean {
        ...
        if (pilotedStarship != null) {
            if (pilotedStarship.id == data._id) {
        ...
        val carriedShips = mutableListOf<PlayerStarship>()
    ...
    private fun getDisplayName(data: PlayerStarship): String {

...
fun World.getChunkAtIfLoaded(chunkX: Int, chunkZ: Int): Chunk? {
    return nms.getChunkIfLoaded(chunkX, chunkZ)?.bukkitChunk
}

fun World.getChunkAtIfLoaded(chunkKey: Long): Chunk? {
    return nms.getChunkIfLoaded(chunkKeyX(chunkKey), chunkKeyZ(chunkKey))?.bukkitChunk
}

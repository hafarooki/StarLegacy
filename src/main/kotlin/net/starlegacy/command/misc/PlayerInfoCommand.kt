...
object PlayerInfoCommand : SLCommand() {
    ...
    private fun sendNationsInfo(sender: CommandSender, slPlayer: SLPlayer) {
        val settlementId: Oid<Settlement>? = slPlayer.settlementId
        ...
        if (settlementId != null) {
            ...
            val nationId = slPlayer.nationId
            ...
            if (nationId != null) {
                ...
                if (sender is Player) {
                    val senderSettlement: Oid<Settlement>? = SLPlayer[sender].settlementId

                    if (senderSettlement != null) {
                        val senderNation: Oid<Nation>? = Settlement.findPropById(senderSettlement, Settlement::nationId)

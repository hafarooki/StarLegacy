...
object CollectedItemCommand : SLCommand() {
    ...
    private fun resolveCollectedItem(name: String): CollectedItem {
        ...
        val ecoStation: EcoStation = EcoStationCache.getByName(stationName)
    ...
    fun onString(sender: Player) {
        ...
        failIf(item.type.isAir) { "You're not holding an item!" }
    ...
    fun onSetValue(sender: CommandSender, item: String, value: Double) = asyncCommand(sender) {
        ...
        sender msg "&aChanged value of ${collectedItem.itemString} at ${EcoStationCache[collectedItem.station].name} " +
    ...
    fun onSetStock(sender: CommandSender, item: String, stock: Int) = asyncCommand(sender) {
        ...
        sender msg "&aChanged stock of ${collectedItem.itemString} at ${EcoStationCache[collectedItem.station].name} " +
    ...
    fun onSetStackRange(sender: CommandSender, item: String, minStacks: Int, maxStacks: Int) {
        asyncCommand(sender) {
            ...
            sender msg "&aChanged stack range of ${collectedItem.itemString} at ${EcoStationCache[collectedItem.station].name} " +
